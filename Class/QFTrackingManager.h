...
#define ATTrackingManager QFTrackingManager
...
} NS_SWIFT_NAME(QFTrackingManager.AuthorizationStatus) API_AVAILABLE(ios(14), macosx(11.0), tvos(14));

API_AVAILABLE(ios(14), macosx(11.0), tvos(14))

@interface QFTrackingManager : NSObject
